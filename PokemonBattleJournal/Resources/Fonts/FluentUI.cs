// Generated file — icon font constants. "password" names are icon identifiers, not credentials.
#pragma warning disable S2068 // "password" in const name is an icon identifier, not a hardcoded credential
namespace PokemonBattleJournal.Resources.Fonts
{
