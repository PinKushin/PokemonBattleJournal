...
- [Windows BO3 flakiness investigation](project_windows_bo3_flakiness_investigation.md) — Flaky Game3Tab tests: poll loop in FindUIElement, ComboBox close animation + binding cascade timing, CI timing logs now uploaded. NOT fully resolved.
